...
| **Instruction** | **Description**                         | **Opcode** | **Arg1**           | **Arg2**            | **Arg3**           | **OK** |
| --------------- | --------------------------------------- | ---------- | ------------------ | ------------------- | ------------------ | ------ |
| **add**         | Addition                                | 0x00       | **dest** : reg     | **arg1** : reg      | **arg2** : reg     | ok     |
| **addi**        | Addition immédiate                      | 0x01       | **dest** : reg     | **arg1** : reg      | **arg2** : int     | ok     |
| **beq**         | Branch if equal                         | 0x02       | **arg1** : reg     | **arg2** : reg      | **target** : label | ok     |
| **bge**         | Branch if greater or equal              | 0x03       | **arg1** : reg     | **arg2** : reg      | **target** : label | ok     |
| **bgt**         | Branch if greater than                  | 0x04       | **arg1** : reg     | **arg2** : reg      | **target** : label | ok     |
| **ble**         | Branch if less or equal                 | 0x05       | **arg1** : reg     | **arg2** : reg      | **target** : label | ok     |
| **blt**         | Branch if less than                     | 0x06       | **arg1** : reg     | **arg2** : reg      | **target** : label | ok     |
| **bne**         | Branch if not equal                     | 0x07       | **arg1** : reg     | **arg2** : reg      | **target** : label | ok     |
| **beqz**        | Branch if equal to zero                 | 0x08       | **arg** : reg      | **target** : label  |                    | ok     |
| **bgez**        | Branch if greater than or equal to zero | 0x09       | **arg** : reg      | **target** : label  |                    | ok     |
| **bgtz**        | Branch if greater than zero             | 0x0A       | **arg** : reg      | **target** : label  |                    | ok     |
| **blez**        | Branch if less than or equal to zero    | 0x0B       | **arg** : reg      | **target** : label  |                    | ok     |
| **bltz**        | Branch if less than zero                | 0x0C       | **arg** : reg      | **target** : label  |                    | ok     |
| **bnez**        | Branch if not equal to zero             | 0x0D       | **arg** : reg      | **target** : label  |                    | ok     |
| **copy**        | Copier un registre                      | 0x14       | **dest** : reg     | **source** : reg    |                    | ok     |
| **del**         | Supprimer la valeur + offset            | 0x0E       | **first** : reg    | **offset** : int    |                    |        |
| **div**         | Division                                | 0x0F       | **dest** : reg     | **arg1** : reg      | **arg2** : reg     | ok     |
| **divi**        | Division immédiate                      | 0x10       | **dest** : reg     | **arg1** : reg      | **arg2** : int     | ok     |
